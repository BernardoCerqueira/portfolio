            ...
            <Container className={styles.techStack}>
                <Container className={styles.techStackTextDiv}>
                    ...
                    <p className={styles.techStackText}>
                        Tenho experiência com <span className={styles.highlight}>HTML5, CSS3, JavaScript, TypeScript, Sass e Bootstrap</span>, além de ferramentas como <span className={styles.highlight}>Git e GitHub</span> para versionamento de código.
                    </p>
                    <p className={styles.techStackText}>
